...
ActiveRecord::Schema.define(version: 20180526084223) do
  ...
  create_table "outletproducts", force: :cascade do |t|
    t.integer "outlet_id"
    t.integer "product_id"
    t.index ["outlet_id"], name: "index_outletproducts_on_outlet_id", using: :btree
    t.index ["product_id"], name: "index_outletproducts_on_product_id", using: :btree
  end
  ...
  create_table "tasks", force: :cascade do |t|
    ...
    t.float    "expect_sale",     default: 0.0
    t.float    "actual_sale",     default: 0.0
    t.integer  "product_id"
  ...
  add_foreign_key "outletproducts", "outlets"
  add_foreign_key "outletproducts", "products"
